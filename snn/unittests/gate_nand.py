'''
Unit test for neuromorphic NAND-gate.
'''
...
with snn.Network() as net:
    NAND = snn.utils.gates.NAND(net = net)
...
I = np.zeros((3, T))
I[2,0] = 1
inj_0_0 = [{'inject': I[0,:].reshape((1, T)), 'into': NAND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': NAND['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': NAND['A']}]

I = np.zeros((3, T))
I[1,0] = 1
I[2,0] = 1
inj_0_1 = [{'inject': I[0,:].reshape((1, T)), 'into': NAND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': NAND['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': NAND['A']}]

I = np.zeros((3, T))
I[0,0] = 1
I[2,0] = 1
inj_1_0 = [{'inject': I[0,:].reshape((1, T)), 'into': NAND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': NAND['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': NAND['A']}]

I = np.zeros((3, T))
I[:,0] = 1
inj_1_1 = [{'inject': I[0,:].reshape((1, T)), 'into': NAND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': NAND['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': NAND['A']}]
