'''
Unit test for neuromorphic XNOR-gate.
'''
...
with snn.Network() as net:
    XNOR = snn.utils.gates.XNOR(net = net)
...
I = np.zeros((3, T))
I[2,0] = 1
inj_0_0 = [{'inject': I[0,:].reshape((1, T)), 'into': XNOR['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': XNOR['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': XNOR['A']}]

I = np.zeros((3, T))
I[1,0] = 1
I[2,0] = 1
inj_0_1 = [{'inject': I[0,:].reshape((1, T)), 'into': XNOR['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': XNOR['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': XNOR['A']}]

I = np.zeros((3, T))
I[0,0] = 1
I[2,0] = 1
inj_1_0 = [{'inject': I[0,:].reshape((1, T)), 'into': XNOR['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': XNOR['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': XNOR['A']}]

I = np.zeros((3, T))
I[:,0] = 1
inj_1_1 = [{'inject': I[0,:].reshape((1, T)), 'into': XNOR['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': XNOR['I1']}, {'inject': I[2,:].reshape((1, T)), 'into': XNOR['A']}]
