'''
Unit test for neuromorphic AND-gate.
'''
...
# setup inputs
I = np.zeros((2, T))
inj_0_0 = [{'inject': I[0,:].reshape((1, T)), 'into': AND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': AND['I1']}]

I = np.zeros((2, T))
I[1,0] = 1
inj_0_1 = [{'inject': I[0,:].reshape((1, T)), 'into': AND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': AND['I1']}]

I = np.zeros((2, T))
I[0,0] = 1
inj_1_0 = [{'inject': I[0,:].reshape((1, T)), 'into': AND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': AND['I1']}]

I = np.zeros((2, T))
I[:,0] = 1
inj_1_1 = [{'inject': I[0,:].reshape((1, T)), 'into': AND['I0']}, {'inject': I[1,:].reshape((1, T)), 'into': AND['I1']}]
